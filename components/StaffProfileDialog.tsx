...
export default function StaffProfileDialog({
  ...
  /** Whether this viewer can open /staff/analytics — managers and admins. */
  ...
  return (
    <>
      <button
        ...
        className="w-full text-left px-3 py-2 hover:bg-well transition-colors"
      ...
      <Modal
        ...
        labelledBy="staff-profile-title"
        className="max-w-lg"
      >
        {/* Who */}
          ...
          <section className="mt-3 border-t border-stone-100 pt-3">
            <div className="flex items-baseline justify-between gap-3">
              ...
              {/* Analytics is a shop screen now, so the way through to it is
                  only offered to the people who can open it. */}
              {canSeeAnalytics && (
                <Link
